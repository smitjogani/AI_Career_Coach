...
import Image from "next/image";import { features } from "@/data/features";
import { howItWorks } from "@/data/howItWoks";
                    ...
                    <div className="flex items-center space-x-4 mb-4">
                      <div className="relative h-12 w-12 flex-shrink-0">
                        <Image
                          ...
                          className="rounded-[100%] object-cover border-2 border-primary/20"
                        />
                      </div>
                      <div>
